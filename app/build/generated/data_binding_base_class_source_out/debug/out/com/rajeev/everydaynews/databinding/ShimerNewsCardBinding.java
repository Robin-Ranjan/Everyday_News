...
public final class ShimerNewsCardBinding implements ViewBinding {
  @NonNull
  ...
  private ShimerNewsCardBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ShimerNewsCardBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ShimerNewsCardBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.shimer_news_card, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ShimerNewsCardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ShimerNewsCardBinding((ConstraintLayout) rootView, articleCard, imageView2,
