...
public final class ShimmerItemNewsListBinding implements ViewBinding {
  ...
  private ShimmerItemNewsListBinding(@NonNull ConstraintLayout rootView, @NonNull Barrier barrier2,
  ...
  @NonNull
  public static ShimmerItemNewsListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ShimmerItemNewsListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.shimmer_item_news_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ShimmerItemNewsListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ShimmerItemNewsListBinding((ConstraintLayout) rootView, barrier2, cardView,
